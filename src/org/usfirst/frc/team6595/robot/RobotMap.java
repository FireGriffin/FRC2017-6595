...
public class RobotMap {
	...
	public static final int XBOX_LEFTSTICK_X = 0;
	public static final int XBOX_LEFTSTICK_Y = 1;
	public static final int XBOX_RIGHTSTICK_X = 4;
	public static final int XBOX_RIGHTSTICK_Y =  5;
	...
	public static final String BASELINE_AUTO = "Baseline Auto";
	public static final String CNTR_PEG_AUTO = "Center Peg Auto";
